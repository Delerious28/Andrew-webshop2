      ...
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="text-xl font-semibold tracking-tight flex items-center gap-2 group">
            <span className="bg-gradient-to-r from-brand to-emerald-500 text-white px-3 py-1 rounded-full shadow-md">Remoof</span>
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm text-slate-600 dark:text-slate-300">
            ...
            {session && <Link href="/profile" className="px-3 py-1.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition">Profile</Link>}
          </nav>
        </div>
